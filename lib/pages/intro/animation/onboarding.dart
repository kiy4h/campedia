...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingPage> _pages = [
    OnboardingPage(
      ...
      description: 'Sewa perlengkapan kemah terbaik, dari tenda hingga kompor. Berkemah jadi mudah dan seru bersama Campedia',
    ...
    OnboardingPage(
      ...
      description: 'Planning your next camping trip? We\'ve got the gear you need — tents, cook sets, lights, and more!',
      backgroundColor: Colors.white,
    ),
    OnboardingPage(
      image: 'images/assets_OnBoarding0/onboarding4image.png',
      title: 'Efficient, In-Store Pickup for Your Camping Rentals',
      subtitle: 'Simply reserve online and pick up your equipment at our store at your convenience.',
  ...
  void _startAutoSlide() {
    _timer = Timer.periodic(const Duration(seconds: 3), (Timer timer) {
      if (_currentPage < _pages.length - 1) {
        ...
        _currentPage = 0; // Kembali ke halaman pertama jika sudah di halaman terakhir.
      }
      ...
      if (_pageController.hasClients) {
        _pageController.animateToPage(
          _currentPage,
          duration: const Duration(milliseconds: 350), // Durasi animasi transisi.
          ...
          children: [
            ...
            Expanded(
              ...
              child: PageView.builder(
                ...
                onPageChanged: _onPageChanged, // Memanggil fungsi saat halaman berubah.
            ...
            Padding(
               ...
               */
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center, // Memusatkan titik-titik.
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFF4A5A2A), // Warna latar belakang tombol (hijau gelap).
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(30), // Sudut tombol membulat.
                        ),
                        padding: const EdgeInsets.symmetric(vertical: 16), // Padding internal tombol.
                      ),
                      /** Widget [Text]
                       * * Deskripsi:
  ...
  Widget _buildDot(bool isActive) {
    return Container(
      margin: const EdgeInsets.symmetric(horizontal: 4), // Margin horizontal antar titik.
      width: isActive ? 20 : 12, // Lebar titik: lebih lebar jika aktif.
      height: 8, // Tinggi titik.
      decoration: BoxDecoration(
        color: isActive ? const Color(0xFF4A5A2A) : Colors.grey[300], // Warna titik: hijau gelap jika aktif, abu-abu jika tidak.
        borderRadius: BorderRadius.circular(20), // Bentuk titik membulat (pill-shaped).
      ),
    );
  }
}

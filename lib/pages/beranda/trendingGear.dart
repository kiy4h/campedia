...
class _TrendingGearPageState extends State<TrendingGearPage> {
      ...
      TrendingGear(
        ...
        testimonials: [
          Testimonial(
              ...
              comment:
                  "Tenda sangat nyaman dan mudah dipasang. Tahan hujan selama camping di Ranca Upas 2 hari.",
              rating: 5.0,
              date: "24 Apr 2025"),
          Testimonial(
          ...
          Testimonial(
              ...
              comment:
                  "Sempat kebingungan saat memasang, tapi secara keseluruhan tenda berkualitas baik.",
              rating: 4.0,
              date: "30 Mar 2025"),
        ],
      ),
      TrendingGear(
        ...
        testimonials: [
          Testimonial(
              ...
              comment:
                  "Sleeping bag-nya hangat dan nyaman. Cocok untuk area camping dengan suhu rendah.",
              rating: 5.0,
              date: "20 Apr 2025"),
          Testimonial(
      ...
      TrendingGear(
        ...
        testimonials: [
          Testimonial(
              ...
              comment:
                  "Kompor hemat gas dan mudah dinyalakan. Sangat membantu untuk camping.",
              rating: 4.0,
              date: "22 Apr 2025"),
          Testimonial(
              ...
              comment:
                  "Agak lambat memanaskan air, tapi cukup baik untuk masak instan.",
              rating: 3.0,
              date: "15 Apr 2025"),
          Testimonial(
  ...
  void _showGearDetails(TrendingGear gear) {
    showModalBottomSheet(
      context: context,
      isScrollControlled:
          true, // Memungkinkan sheet menempati lebih dari separuh layar dan dapat di-scroll.
      ...
      builder: (context) {
        ...
        return DraggableScrollableSheet(
          initialChildSize:
              0.6, // Ukuran awal sheet saat pertama kali muncul (60% layar).
                  ...
                  child: ListView(
                    ...
                    children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(children: [
                                  ...
                                  Text("${gear.price.toStringAsFixed(2)}/hari",
                                      style: TextStyle(
                                          fontSize: 16,
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                    content: Text(
                                        "${gear.name} ditambahkan ke keranjang!")));
                          ...
                          Expanded(
                            ...
                            child: OutlinedButton(
                              onPressed: () {
                                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                    content: Text(
                                        "${gear.name} ditambahkan ke wishlist!")));
                              },
                      ...
                      Row(
                        ...
                        children: [
                          const Text("Testimoni Pengguna",
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.bold)),
                          Text("${gear.testimonials.length} ulasan",
                              style: TextStyle(
                      ...
                      ...gear.testimonials.map(
                          (testimonial) => _buildTestimonialItem(testimonial)),
                      const SizedBox(height: 24),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // AppBar halaman.
      appBar: AppBar(
        title: const Text("Trending Gear",
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () =>
                _showGearDetails(gear), // Menampilkan detail saat diklik.
                                      ...
                                      onTap: () {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(SnackBar(
                                                content: Text(
                                                    "${gear.name} disimpan ke wishlist!")));
                                      },
                                      child: const Icon(Icons.favorite_border,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ScaffoldMessenger.of(context)
              .showSnackBar(const SnackBar(content: Text("Keranjang Sewa")));
        },
      ),
    );
  }

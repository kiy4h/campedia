...
class _RecommendedGearTripPageState extends State<RecommendedGearTripPage> {
  ...
  void initState() {
    ...
    hardcodedDestinations = [
      CampingDestination(name: "Mount Fuji",imagePath: "images/assets_DestinationCamp/gunung1.jpg",location: "Japan",description: "A beautiful mountain for hiking and camping.",gears: [RecommendedGear(name: "Tent", imagePath: "images/assets_Categories/cat_Jaket.png", price: 100),RecommendedGear(name: "Sleeping Bag", imagePath: "images/assets_Categories/cat_Sepatu.png", price: 50),],),
      CampingDestination(name: "Banff National Park",imagePath: "images/assets_DestinationCamp/gunung2.jpg",location: "Canada",description: "Stunning lakes and mountainous terrain.",gears: [RecommendedGear(name: "Hiking Boots", imagePath: "images/assets_Categories/cat_Tenda.png", price: 120),RecommendedGear(name: "Camping Stove", imagePath: "images/assets_Categories/cat_Tas.png", price: 60),],),
      CampingDestination(name: "Mount Fuji",imagePath: "images/assets_DestinationCamp/gunung3.jpg",location: "Japan",description: "A beautiful mountain for hiking and camping.",gears: [RecommendedGear(name: "Tent", imagePath: "images/assets_Categories/cat_Jaket.png", price: 100),RecommendedGear(name: "Sleeping Bag", imagePath: "images/assets_Categories/cat_Sepatu.png", price: 50),],),
      CampingDestination(name: "Banff National Park",imagePath: "images/assets_DestinationCamp/gunung4.jpg",location: "Canada",description: "Stunning lakes and mountainous terrain.",gears: [RecommendedGear(name: "Hiking Boots", imagePath: "images/assets_Categories/cat_Tenda.png", price: 120),RecommendedGear(name: "Camping Stove", imagePath: "images/assets_Categories/cat_Tas.png", price: 60),],),
    ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Destinasi Camping", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
          ...
          Padding(
            ...
            child: Container(
              ...
              child: TextField(
                ...
                onChanged: fetchDestinations, // Memanggil filter setiap kali teks berubah.
          ...
          isLoading
              ...
              : Expanded(
                  ...
                  child: filteredDestinations.isEmpty
                      ? const Center(child: Text("Tidak ada destinasi yang ditemukan", style: TextStyle(color: Colors.grey)))
                                      ...
                                      children: [
                                        ...
                                        ClipRRect(
                                          ...
                                          child: Image.asset( // Menggunakan Image.asset karena path lokal.
                                            ...
                                            height: 150,
                                            fit: BoxFit.cover,
                                            errorBuilder: (context, error, stackTrace) => Container(height: 150, color: Colors.grey[300], child: const Center(child: Icon(Icons.image_not_supported, color: Colors.white))),
                                          ),
                                        ),
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(destination.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.black)),
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Text(destination.location, style: TextStyle(color: Colors.grey.shade700, fontSize: 14)),
                                                    ],
                                                  ),
                                                ],
                                              ),
                                            ...
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  const SizedBox(width: 4),
                                                  Text("${destination.gears.length} Items", style: TextStyle(color: Colors.green[700], fontWeight: FontWeight.bold, fontSize: 12)),
                                                ],
                                              ),
                                            ),
                                          ],
                                        ...
                                        Text(destination.description, style: TextStyle(color: Colors.grey.shade600, fontSize: 13), maxLines: 2, overflow: TextOverflow.ellipsis),
                                      ],
                                    ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            const Padding(
                                              ...
                                              child: Text("Perlengkapan yang Direkomendasikan", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                                            ),
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Image.asset(gear.imagePath, fit: BoxFit.contain, errorBuilder: (context, error, stackTrace) => const Icon(Icons.image_not_supported, color: Colors.grey)),
                                                    ),
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(gear.name, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 15)),
                                                          const SizedBox(height: 4),
                                                          Row(
                                                            children: [
                                                              Icon(Icons.attach_money, size: 16, color: Colors.green[700]),
                                                              const SizedBox(width: 4),
                                                              Text(gear.price.toStringAsFixed(2), style: TextStyle(fontSize: 14, color: Colors.grey.shade700)),
                                                            ],
                                                          ),
                                                        ],
                                                      ),

...
class HomePage extends StatelessWidget {
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildTrendingItem(item, context);
            },
          ),
        ),
      ],
  ...
  Widget _buildTrendingItem(Map<String, dynamic> item, context) {
    return GestureDetector(
      onTap: () {
  ...
  Widget _buildMoreButton(BuildContext context) {
    return Center(
      child: ElevatedButton(
        onPressed: () {
          // Navigate to a page showing more items or details
        },
